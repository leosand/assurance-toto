...
const RELAY_SK=process.argv[2], CEO_PK=process.argv[3];
...
process.stdout.write(JSON.stringify({ correlation_id:corr, author_pubkey:getPublicKey(sk), command:cmd, event:ev }));
